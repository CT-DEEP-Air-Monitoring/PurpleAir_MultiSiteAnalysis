...
#reference data, the data is merging based on this so only pull data from envista that
...
#This makes a list of time series plots with two loops, first through the quarter/year then through Site
#Output is a time series graph for each quarter/year for each site
timeseries = list()
idx <- 1
